...
for (i in seq(1,NumberCDS)) {
  ...
  if (i == 1) {
    CC = CDS1_USD_XR_MARGINAL_CreditCurve
  }
  else if (i == 2) {
    CC = CDS2_USD_XR_MARGINAL_CreditCurve
  }
  else if (i == 3) {
    CC = CDS3_USD_XR_MARGINAL_CreditCurve
  }
  else if (i == 4) {
    CC = CDS4_USD_XR_MARGINAL_CreditCurve
  }
  else if (i == 5) {
    CC = CDS5_USD_XR_MARGINAL_CreditCurve
  }
