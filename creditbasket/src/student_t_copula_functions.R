...
BasketCDSPricing_StudentTCopulaV2 = function(CreditCurve1,CreditCurve2,CreditCurve3,CreditCurve4,CreditCurve5,YieldCurve,CorrelationMatrix,DegreeFreedom,RecoveryRate,k=1,NumberSimulation=300000) {
  NumberCDS = 5
  ...
  for (i in seq(1,NumberSimulation)) {
    ...
    if (tau_list[1] == Inf) {
      ...
      premium_leg = ComputePremiumLeg(YieldCurve,k,tau_list)
    }
