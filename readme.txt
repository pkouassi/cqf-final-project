...
Welcome!
You'll find the on this thumbdrive the sources code (+ data) for the 2 selected topics and a soft copy of the report.
...
#==============================================================================
This program has been written using R (version 3.1.0, 64-bit) and Rstudio as IDE. In order to launch this program, please follow this procedure:
...
4. Launch R
5. type: source ("C:/temp/creditbasket/src/master_program.R") (replace the path to master_program.R to match your environment)
...
4. Launch R
5. type: source ("C:/temp/interestrate-hjm/src/master_program.R") (replace the path to master_program.R to match your environment)
6. The program will start.
