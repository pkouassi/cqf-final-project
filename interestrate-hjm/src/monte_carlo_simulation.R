...
# timestamp = Sys.time()
# ans_hjm2 = HeathJarrowMortonPricing("cap",1,maturity_list,strike_list,ValuationDateForwardCurve$rate/100,ValuationDateOISYieldCurve,10000,"nag-sobol")
...
ans_hjm3 = HeathJarrowMortonPricing("cap",1,maturity_list,strike_list,ValuationDateForwardCurve$rate/100,ValuationDateOISYieldCurve,10000,"nag-niederreiter")

ans_hjm4 = HeathJarrowMortonPricing("cap",1,maturity_list,strike_list,ValuationDateForwardCurve$rate/100,ValuationDateOISYieldCurve,10000,"rnorm")

ans_hjm5 = HeathJarrowMortonPricing("swap",1,c(2,3,4,5),NA,ValuationDateForwardCurve$rate/100,ValuationDateOISYieldCurve,10000,"nag-sobol")
ans_hjm6 = HeathJarrowMortonPricing("swap",2,c(3,4,5),NA,ValuationDateForwardCurve$rate/100,ValuationDateOISYieldCurve,10000,"nag-sobol")
ans_hjm7 = HeathJarrowMortonPricing("swap",1,c(4,5),NA,ValuationDateForwardCurve$rate/100,ValuationDateOISYieldCurve,10000,"nag-sobol")

ans_hjm8 = HeathJarrowMortonPricing("swaption",1,maturity_list,strike_list,ValuationDateForwardCurve$rate/100,ValuationDateOISYieldCurve,10000,"nag-sobol")
